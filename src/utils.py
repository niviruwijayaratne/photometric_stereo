...
def gamma_correction_sRGB(nonlinear_image):
    linear_image = nonlinear_image.copy()
    linear_image[np.where(nonlinear_image <= 0.0404482)] = (
        nonlinear_image[np.where(nonlinear_image <= 0.0404482)] / 12.92)
    linear_image[np.where(nonlinear_image > 0.0404482)] = np.power(
        (nonlinear_image[np.where(nonlinear_image > 0.0404482)] + 0.055) /
        1.055, 2.4)
